...
class OrganisersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organiser" do
    assert_difference('Organiser.count') do
      post organisers_url, params: { organiser: { description: @organiser.description, name: @organiser.name } }
    end
  ...
  test "should update organiser" do
    patch organiser_url(@organiser), params: { organiser: { description: @organiser.description, name: @organiser.name } }
